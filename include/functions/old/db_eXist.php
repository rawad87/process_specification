...
{ 
  ...
  public function __construct($user="guest", $password="guest", $wsdl="http://10.0.2.206:8080/exist/services/Query?wsdl")
  {
	  $this->_user = $user;
...
{ 
  public function __construct($user="guest", $password="guest", $wsdl="http://10.0.2.206:8080/exist/services/Admin?wsdl")
  {
	  $this->_user = $user;
	  $this->_password = $password;
	  $this->_wsdl = $wsdl;
